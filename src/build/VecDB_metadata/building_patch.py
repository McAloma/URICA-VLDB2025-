...
class WSI_Image_Vector_DB_Builder():
    def __init__(self, step):
        ...
        self.embed_cache_path = f"data/metadata_embedding_{self.step}"
        self.database_path = f"data/vector_database_{self.step}"
...
if __name__ == "__main__":
    ...
    for t in [150, 100, 75, 50]:
        builder = WSI_Image_Vector_DB_Builder(step=t)
