...
class WSI_Image_Vector_DB_Builder():
    def __init__(self, step):
        ...
        self.embed_cache_path = f"data/metadata_embedding_TCGA_{step}"
        self.database_path = f"data/vector_database_TCGA_{step}"
    ...
    def insert_worker(self, input_queue):
        while True:
            ...
            for info in patch_infos_pbar:
                ...
                patch_id = str(uuid.uuid5(UUID_NAMESPACE, ''.join(map(str, info.values()))))
...
if __name__ == "__main__":
    ...
    for step in [224, 200, 150, 100, 80, 60, 50]:
        builder = WSI_Image_Vector_DB_Builder(step)
